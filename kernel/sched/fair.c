...
#if defined(CONFIG_SCHED_HMP) || defined(CONFIG_SCHED_HMP_CUSTOM)
/*
 * Migration thresholds should be in the range [1..1024]
...
static u64 hmp_boostpulse_endtime = 0;
static int hmp_boost_val = 0;
static int hmp_family_boost_val = 0;
static int hmp_semiboost_val = 0;
 ...
 * Both must be between 1 and 1024. The threshold that is compared
